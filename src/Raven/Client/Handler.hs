...
-- |Handle events
handler :: Connection -> (Text,Vector (Text,Text,Int),Int) -> BrickEvent n [Text] ->
...
-- |Handle key events
handleKey :: Connection -> (Text,Vector (Text,Text,Int),Int) -> Key -> [Modifier] ->
  EventM n (Next (Text,Vector (Text,Text,Int),Int))
...
handleApp :: (Text,Vector (Text,Text,Int),Int) -> [Text] ->
  EventM n (Next (Text,Vector (Text,Text,Int),Int))
handleApp (_,ios,hs) [conErr] = continue (conErr,ios,hs)
